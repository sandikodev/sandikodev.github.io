...
export default function Layout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <>
      ...
      <Footer className='fixed bottom-0 flex h-16 w-full items-center justify-center border-solid bg-gray-200 hover:bg-gray-200/75 dark:bg-gray-700 dark:text-gray-300' />
    </>
  );
}
